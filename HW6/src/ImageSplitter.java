...
public class ImageSplitter {
	...
	private static BufferedImage topRightImg = null;//works for 2x2, 3x3 and 4x4 grid
	...
	private static BufferedImage botLeftImg = null; //works for 2x2, 3x3 and 4x4 grid	
	...
	private static BufferedImage botRightImg = null; //works for 2x2, 3x3 and 4x4 grid
	...
	public ImageSplitter(int userIn, String f){
		...
		try 
		{
		    ...
		    if(userIn==4){
		    	...
		    	topRightImg = img.getSubimage(((width / 3)*2), 0, (width / 3), (height / 3)); //x-coord starts at 1/3 of the total width multiplied by 2
		    	...
		    	topRightMidImg = img.getSubimage(((width / 3)*2), 0, (width / 3), (height / 3)); //x-coord starts at 1/3 of the total width multiplied by 2
